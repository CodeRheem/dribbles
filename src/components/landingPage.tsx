...
export default function LandingPage() {
  return (
    <div 
      className="mx-auto min-h-screen p-4 bg-cover bg-center border border-white rounded-3xl mt-3 px-4"
    ...
    >
      ...
      {/* Page content */}
      <main className="absolute right-20 top-3/5 transform -translate-y-1/2 font-[Outfit]">
        <div>
          ...
          <div className="flex items-center gap-4 mt-15 text-white dark:text-white">
            <Button>Smart</Button>
            <Button>Safe</Button>
